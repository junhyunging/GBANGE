...
<c:set var="contextPath" value="${pageContext.request.contextPath}"/>
  <nav id="top-nav">
    <ul>
        ...
        <li><a href="https://www.instagram.com/gban_ge/?next=%2Faccounts%2Flogout%2F"><img style="width:32px; height:32px;" id="user-profile" src="views/common/resources/img/free-icon-instagram-733558.png"></a> </li>
